 ...
 */
public class TestCheckListAdapter extends ArrayAdapter<CheckList> {

    private final List<CheckList> checkListValues;
    private final Activity context;

    public TestCheckListAdapter(Activity context, List<CheckList> values) {
            ...
            checkListViewHolder.yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(!checkListViewHolder.yes.isSelected()) {
                        ...
                        checkListViewHolder.no.setBackgroundColor(Color.LTGRAY);
                        checkListViewHolder.na.setBackgroundColor(Color.LTGRAY);
                        ...
                        checkListViewHolder.yes.setBackgroundColor(Color.LTGRAY);
//                        checkListViewHolder.no.setBackgroundColor(Color.LTGRAY);
//                        checkListViewHolder.na.setBackgroundColor(Color.LTGRAY);
